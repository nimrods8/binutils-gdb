...
#ifndef TUI_TUI_DECOMP_H
#define TUI_TUI_DECOMP_H
...
struct tui_decomp_window : public tui_source_window_base
{
  tui_decomp_window () = default;

  DISABLE_COPY_AND_ASSIGN (tui_decomp_window);
  ...
  {
    do_erase_source_content (_("[ No Decompilation Available ]"));
  }
